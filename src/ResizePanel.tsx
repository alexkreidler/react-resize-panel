...
interface IProps {
  // Indicates the directions that the panel is allowed to be resized in
  direction: "n" | "s" | "e" | "w";
  handleClass: string;
  borderClass: string;
...
class ResizePanel extends React.Component<IProps, IState> {
  ...
  handleDragEnd: DraggableEventHandler = (e, ui) => {
    this.validateSize();
  };
